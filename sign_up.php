         ...
         <div class="main_div">
           ...
           <div class="col-md-6 second_section">
                <div style=" padding: 0 32px; height: 490px;">
                    <h1 class="signup_tittle">Sign Up</h1>
                    <p class="signup_para">Sign up or Sign in to access your orders, special offers, health tips and more!</p>
            <form action="action/account.php" method="POST" enctype="multipart/form-data">
                    <label class="signup_label">Name</label>
                    ...
                    <label class="signup_label">Phone Number</label>

                    <input type="text" name="mobile_no" class="signup_input">

                    <label class="signup_label">Password</label>

                    <input type="password" name="password" class="signup_input">

                    <button type="submit" name="submit" value="submit" class="signup_log">Sign Up Button</button>
                    </form>
                </div>
            </div>
         </div>
